...
{
    public class SampleData : DropCreateDatabaseAlways<MusicSroreContext>
    {
        protected override void Seed(MusicSroreContext context)
        {
            ...
            }.ForEach(a => context.AlbumSet.Add(a));
        }
    }
}